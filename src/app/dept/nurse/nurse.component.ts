...
import { DoctorRecord, Nurse, NurseRecord } from './nurse.model';
import { FormBuilder, FormControl, FormGroup, Validators } from '@angular/forms';
import { NzTableFilterFn, NzTableFilterList } from 'ng-zorro-antd/table';
import { NurseColumn } from './nurse.column';
...
export class NurseComponent implements OnInit {
  backupList: Nurse[] = []
  listData: Nurse[] = [
    new Nurse(new Date("2/8/2021"),1,1,"mr","สมชาย รักดี",
    ...
    new Nurse(new Date("2/8/2021"),2,3,"miss","สมหญิง รักดี",
    undefined,undefined,undefined,undefined,undefined,undefined,undefined,undefined,
    [new DoctorRecord("1",new Date("2/8/2021"),"เหลือง")],[new NurseRecord("2",new Date("2/9/2021"))],undefined),
    new Nurse(new Date("2/8/2021"),3,4,"mr","สมศักด์ รักดี",
    undefined,undefined,undefined,undefined,undefined,undefined,undefined,undefined,
    [new DoctorRecord("1",new Date("2/8/2021"),"เหลือง")],[new NurseRecord("2",new Date("2/9/2021"))],undefined),
    new Nurse(new Date("2/8/2021"),4,5,"miss","สมปอง รักดี",
    undefined,undefined,undefined,undefined,undefined,undefined,undefined,undefined,
    [new DoctorRecord("1",new Date("2/7/2021"),"เหลือง")],[new NurseRecord("3",new Date("2/8/2021"))],undefined),
  ]
  current = new Nurse()
  listColumns = new NurseColumn().listColumns
  ...
  updateData(data: Nurse, content: TemplateRef<{}>) {
    this.current = Object.assign(new Nurse(), data)
    this.modal.create({
